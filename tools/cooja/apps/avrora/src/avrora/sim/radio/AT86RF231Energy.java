...
public abstract class AT86RF231Energy {  
    ...
    public static final double[] modeAmpere = {                                             
        ...
        0.000420,  //TRX_OFF 420 uA
        0.00550,   //P_ON, PLL_ON 5.5 mA
        0.0124,    //Software CCA state, to signal the event to Cooja
    ...
    public static String[] allModeNames() {
        ...
        System.arraycopy(AT86RF231Energy.modeName, 0, modeName, 0, 7);
        for (int i = 0; i < 16; i++) {
            modeName[i + 7] = AT86RF231Energy.modeName[7] + StringUtil.leftJustify(i+":  ", 2);
        }
        return modeName;
    }
}
