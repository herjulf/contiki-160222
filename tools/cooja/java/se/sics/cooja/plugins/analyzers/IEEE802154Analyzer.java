...
//      boolean security    = (packet.data[pos + 0] & 0x04 ) != 0;
        boolean pending     = (packet.data[pos + 0] & 0x10 ) != 0;
        boolean ackRequired = (packet.data[pos + 0] & 0x20 ) != 0;
//      boolean intraPan    = (packet.data[pos + 0] & 0x40 ) != 0;
...
//        int payloadLen = packet.data.length - pos;
 ...
 //     brief.append(intraPan    ? "I":"-");
        brief.append(ackRequired ? "A":"-");
        brief.append(pending     ? "P":"-");
 //     brief.append(security    ? "S":"-");
